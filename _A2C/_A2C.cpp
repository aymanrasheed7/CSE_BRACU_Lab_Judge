...
int nTest[] = { 0, 2, 2, 20, 2, 200, 20, 2000, 2, 200, 20000 };
int maxN[] = { 0, 10, 10, 50, 500, 50, 500, 50, 5000, 500, 50 };
int maxS[] = { 0, 10, 100, 1000, 10000, 100000,
    1000000, 10000000, 100000000, tn9, tn9 };
int maxAi[] = { 0, 10, 100, 1000, 10000, 100000,
    1000000, 10000000, 100000000, tn9, tn9 };
int outputHash[] = { 0, 7469, 7469, 6067, 7469, 57751,
