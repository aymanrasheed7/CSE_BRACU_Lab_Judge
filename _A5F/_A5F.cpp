...
int outputHash[] = { 0, 56637, 58086, 34081, 16299, 58086 };
...
inline void prepareInput() {
    ...
    if (batch == 1) {
        InputN = { 4, 5 };
        InputM = { 7, 4 };
        InputU = { {1, 1, 2, 3, 2, 4, 4}, {5, 3, 2, 2} };
        InputV = { {3, 2, 4, 1, 3, 3, 1}, {1, 1, 3, 4} };
    }
    else if (batch == 2) {
        InputN = { 6, 6 };
        InputM = { 5, 6 };
        InputU = { {6, 6, 4, 6, 4}, {5, 1, 1, 5, 4, 3} };
        InputV = { {4, 3, 5, 2, 1}, {1, 2, 4, 2, 5, 2} };
    }
    else {
