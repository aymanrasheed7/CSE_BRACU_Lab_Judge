...
int nTest[] = { 0, 2, 2, 20000, 4, 4 };
int maxN[] = { 0, 5, 10, 16, 1000, 2000 };
int outputHash[] = { 0, 14184, 14698, 18141, 41839, 16571 };
vector<string> OutputH;
vector<int> InputN, InputK, InputX, InputY;
...
inline void prepareInput() {
    if (batch == 1) {
        ...
        for (int N = 1, K, X, Y = test = 0; N <= maxN[batch]; ++N)
